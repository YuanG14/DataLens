import { getScoreColorClass } from '@/features/dashboard/lib/stats';
import { exportRecordsAsCsv } from '@/features/dashboard/lib/csv';
import { TABLE_PAGE_SIZE } from '@/features/dashboard/lib/constants';
...
export function RecordTable({ data }: RecordTableProps) {
  ...
  const visibleRows = data.slice(0, TABLE_PAGE_SIZE);
